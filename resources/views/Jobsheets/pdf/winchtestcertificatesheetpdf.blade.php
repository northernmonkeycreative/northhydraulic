...
<body>
    ...
    <table class="table table-bordered text-center">
        <thead style="background:#3377FF;color:white;padding:40px;">
            <tr>
                <th colspan="3">
                    ...
                    <p style="font-size:20px;">Winch Test Certificate</p>
                </th>
            </tr>
        </thead>
        <tbody class="text-left">
            ...
            <tr>
                <td colspan="3"><span class="formtitle">Vehicle Serial:</span> {{$vehicle_serial}}</td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="3"><span class="formtitle">Type:</span> {{$lifting_type}}</td>
            </tr>
            <tr>
                <td colspan="3"><span class="formtitle">Serial:</span> {{$lifting_serial}}</td>
            </tr>
            <tr>
                <td colspan="3"><span class="formtitle">SWL:</span> {{$lifting_swl}} Tons</td>
            </tr>
            <tr>
                <td colspan="3"><span class="formtitle">Year:</span> {{$lifting_year}}</td>
            </tr>
            <tr>
                <td colspan="3"><span class="formtitle">Unlaiden:</span> {{$lifting_unladen}}kg</td>
            </tr>
            <tr>
                <td colspan="3"><span class="formtitle">Max Laden:</span> {{$lifting_maxladen}}kg</td>
            </tr>
            <tr>
                <td colspan="3"><span class="formtitle">Tested At:</span> {{$tested_at}}kg</td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2"><span class="formtitle">Signature of Engineer:</span> {{$engineer_signature}}</td>
