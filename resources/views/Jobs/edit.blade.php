                                    ...
                                    <form action="{{ route('job.update', $thejob) }}" class="form-horizontal" role="form" method="POST">
                                        ...
                                        <div class="px-4 py-5 bg-white sm:p-6">
                                            <div class="grid grid-cols-6 gap-6">
                                                ...
                                                <input type="number" name="hours" id="hours" autocomplete="hours" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('hours', $thejob->hours) }}">
                                                </div>
